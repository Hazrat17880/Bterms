...
function SomethingElse() {
  ...
  return (
    <div className="somethingelse mt-[110px]">
      <p className="somethingelse-question1">Something else</p>
      <div className="somethingelse-question-answer px-3 py-3">
        <p>
          <FontAwesomeIcon icon={faBrain} className="px-4" />
          Bterms boot
        </p>
        <p className="somethingelse-para">
