...
function ReportBugs() {
  ...
  return (
    <div className="ShowPayment mt-[120px]">
      <p className="Report-bugs-question1">Report bugs or issues</p>
      <div className="Report-bugs-question-answer px-3 py-3">
        <p>
          <FontAwesomeIcon icon={faBrain} className="px-4" />
          Bterms boot
        </p>
        <p className="Report-bugs-para">
